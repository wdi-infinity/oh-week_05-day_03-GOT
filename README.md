...
![](https://media.giphy.com/media/HygJsrb3I7KbS/giphy.gif)


Using the following data, create a list of GOT families by creating the following components:

- `<Families>` show all family names, state is an array of families
- `<Family>` show a single family's data, state is a single family
- `<Member>` show single family member data, state is a single family member
You may use other components as you see fit.

For urls to wikiSuffix and imageSuffix...

```
// wikisuffix
http://gameofthrones.wikia.com/wiki/{{wikiSuffix}}
http://gameofthrones.wikia.com/wiki/Brynden_Tully

// imagesuffix
http://cheatsheetworld.com/img/entertainment/game-of-thrones/game-of-thrones-{{imageSuffix}}.jpg"
